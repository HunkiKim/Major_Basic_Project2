...
public class Repository {
    ...
    protected void createEmptyDataFile(String path, String header) throws IOException {
    ...
    public interface DtoHelper<T> {
        T transToDto(List<String> parsedData, HashSet<Integer> uniquePolicy);
    }

    protected <T> List<T> loadData(String path, DtoHelper<T> dtoHelper) {
        ...
        try {
            ...
            lines.forEach((line)-> {
                ...
                try {
                    ...
                    result.add(dtoHelper.transToDto(parsed, uniquePolicy));
